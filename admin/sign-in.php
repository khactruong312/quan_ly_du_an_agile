...
<body>
    <div
        class="h-screen w-full flex items-center justify-center bg-neutral-100 bg-[url(../assets/img/sign-in-bg.svg)] bg-no-repeat bg-top bg-cover">
            ...
            <form class="x-8 pt-6 pb-8 mb-4 w-full" method="post" action="">
                <div class="flex flex-col space-y-6">
                    <div>
                        ...
                        <input class="form-input text-sm rounded-md w-full" id="email" name="email" type="text"
                    ...
                    <div class="relative">
                        ...
                        <input class="form-input text-sm rounded-md w-full pr-[50px]" id="password" name="password"
                            type="password">
                        <div
                            class="toggle-show-password absolute cursor-pointer h-[40px] w-[40px] right-1 top-[41%]  flex items-center justify-center">
                            <i class="bi bi-eye "></i>
                        </div>
                        <?php echo !empty($error['password']) ? '<span class="text-red-500 text-sm">' . $error['password'] . '</span>' : "" ?>
                    </div>
                    <button class="btn md:btn-md btn-sm capitalize bg-slate-700 hover:bg-slate-800 w-full text-white"
